...
const Login = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-gray-50/50 px-4">
            <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                <div className="p-8 md:p-10">
                    <div className="text-center mb-10">
                        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-100 text-worko-blue mb-6 shadow-sm transform -rotate-3">
                            <LogIn size={32} />
                        </div>
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">Welcome Back</h2>
                        <p className="text-gray-500">Sign in to manage your referrals</p>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-600">
                        ...
                        <Link to="/register" className="font-semibold text-worko-blue hover:text-blue-700 transition-colors">
                            Create account
                        </Link>
                    </div>
                </div>
